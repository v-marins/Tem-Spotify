    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12" id="titulo">
                <h2>Tem Spotify - Novo Usu&aacuterio</h2>
            </div>
        </div>
        ...
        <div class="row" id="conteudo">
            ...
            <div class="col-md-6">
                ...
                <!--Formul�rio Login-->
                <form role="form"data-bitwarden-watching="1" action="efetivacadastro" method="post">
                    <div class="form-group" id="formularioLogin">
                        <label for="exampleInputName1">Nome</label>
                        <input type="text" class="form-control" id="exampleInputName1" name="txtName">
                    </div>
